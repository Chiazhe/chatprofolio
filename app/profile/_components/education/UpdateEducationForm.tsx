...
import { educationFormSchema, EducationType } from "@/lib/zodSchema/education";
...
type Props = {
  existingEducations: EducationType["educations"];
};
...
const UpdateEducationForm = ({ existingEducations }: Props) => {
  ...
  function onSubmit(values: EducationType) {
    console.log(values);
  ...
  return (
    <Form {...form}>
      ...
      {/* {JSON.stringify(existingEducations)} */}
